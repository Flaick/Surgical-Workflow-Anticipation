...
def videos_to_imgs(output_path="/Videos/output",
    ...
    for i, vid_path in enumerate(tqdm(dirs[-2:])):
...
if __name__ == "__main__":
    videos_to_imgs(output_path='/home/kun/Desktop/miccai21/TeCNO/Videos/output', input_path='/home/kun/Desktop/aniticipation/data/cholec80/videos')
