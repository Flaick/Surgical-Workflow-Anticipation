...
def build_configargparser(parser):
    ...
    dataset_group.add_argument("--horizon", default=2, type=int)
    dataset_group.add_argument("--num_ins", default=5, type=int)
    dataset_group.add_argument("--num_phase", default=7, type=int)
    ...
    trainer_group.add_argument("--box_emb_size", type=int, default=64)
